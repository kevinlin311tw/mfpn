...
def ResNet101RetinaNetKeypoint(inputs, num_classes, weights='imagenet', *args, **kwargs):
    image = inputs
    ...
    model = retinanet.retinanet_kp_bbox(inputs=inputs, num_classes=num_classes, backbone=resnet, *args, **kwargs)
    model.load_weights(weights_path, by_name=True)
    return model