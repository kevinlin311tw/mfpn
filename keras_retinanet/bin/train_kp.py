...
from ..models.resnet import ResNet101RetinaNetKeypoint
...
def create_models(num_classes, weights='imagenet', multi_gpu=0):
    ...
    if multi_gpu > 1:
        with tf.device('/cpu:0'):
            model = ResNet101RetinaNetKeypoint(image, num_classes=num_classes, weights=weights, nms=False)
    ...
    training_model.compile(
        loss={
            ...
            'keypoint'      : keras.losses.binary_crossentropy
        },
...
def create_generators(args):
    ...
    if args.dataset_type == 'coco':
        ...
        from ..preprocessing.coco_kp import CocoGeneratorKeypoint

        train_generator = CocoGeneratorKeypoint(
            args.coco_path,
            'train2017',
        ...
        validation_generator = CocoGeneratorKeypoint(
            args.coco_path,
            'val2017',
...
def main(args=None):
    ...
    model, training_model, prediction_model = create_models(num_classes=1, weights=args.weights, multi_gpu=args.multi_gpu)

    # print model summary
    # print(model.summary())
    # plot_model(model, to_file='model_keypoint.png', show_shapes=True)
